...
describe('BorrowedBook Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'borrowed-book', component: BorrowedBookComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to borrowedBookService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBorrowedBookIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBorrowedBookIdentifier).toHaveBeenCalledWith(entity);
