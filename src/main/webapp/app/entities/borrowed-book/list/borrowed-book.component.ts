...
import { EntityArrayResponseType, BorrowedBookService } from '../service/borrowed-book.service';
...
export class BorrowedBookComponent implements OnInit {
  ...
  trackId = (_index: number, item: IBorrowedBook): number => this.borrowedBookService.getBorrowedBookIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.borrowedBooks = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IBorrowedBook[] | null): IBorrowedBook[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.borrowedBookService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
