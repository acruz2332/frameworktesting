...
describe('Book Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call publisher query and add missing value', () => {
      ...
      const publisher: IPublisher = { id: 10545 };
      book.publisher = publisher;

      const publisherCollection: IPublisher[] = [{ id: 17677 }];
    ...
    it('Should call Author query and add missing value', () => {
      const book: IBook = { id: 456 };
      const authors: IAuthor[] = [{ id: 10767 }];
      book.authors = authors;

      const authorCollection: IAuthor[] = [{ id: 2658 }];
    ...
    it('Should update editForm', () => {
      const book: IBook = { id: 456 };
      const publisher: IPublisher = { id: 5722 };
      book.publisher = publisher;
      const author: IAuthor = { id: 15509 };
      book.authors = [author];
