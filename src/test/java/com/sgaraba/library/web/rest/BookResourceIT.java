...
class BookResourceIT {
    ...
    @Test
    @Transactional
    void getAllBooksByBorrowedBookIsEqualToSomething() throws Exception {
        ...
        em.flush();
        book.setBorrowedBook(borrowedBook);
        borrowedBook.setBook(book);
        bookRepository.saveAndFlush(book);
        Long borrowedBookId = borrowedBook.getId();
        // Get all the bookList where borrowedBook equals to borrowedBookId
        defaultBookShouldBeFound("borrowedBookId.equals=" + borrowedBookId);

        // Get all the bookList where borrowedBook equals to (borrowedBookId + 1)
        defaultBookShouldNotBeFound("borrowedBookId.equals=" + (borrowedBookId + 1));
    }
