...
describe('Author e2e test', () => {
  ...
  const authorSample = { firstName: 'Matilde', lastName: 'Kirlin' };
  ...
  describe('new Author page', () => {
    ...
    it('should create an instance of Author', () => {
      cy.get(`[data-cy="firstName"]`).type('Lillian');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Lillian');

      cy.get(`[data-cy="lastName"]`).type('Strosin');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Strosin');
